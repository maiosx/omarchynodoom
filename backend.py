...
def intent_handoff(
    ...
    *,
    ...
    # xdg-open exposes its argument through /proc. Put the (possibly
    # draft-bearing) URL in an owner-only local redirect document; argv
    # contains only its random path.
